...
public class LocationService {
    ...
    public Location createLocation(Location location) {
        ...
        if (location.getParentLocation() != null && location.getParentLocation().getLocationId() != null) {
            Optional<Location> parentLocation = locationRepository.findById(location.getParentLocation().getLocationId());
    ...
    public Location updateLocation(Long id, Location locationDetails) {
        ...
        if (location.isPresent()) {
            ...
            if (locationDetails.getParentLocation() != null && locationDetails.getParentLocation().getLocationId() != null) {
                Optional<Location> parentLocation = locationRepository.findById(locationDetails.getParentLocation().getLocationId());
                if (parentLocation.isPresent()) {
                    existingLocation.setParentLocation(parentLocation.get());
                }
            } else {
